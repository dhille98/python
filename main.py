...
key_vault_name = "azureb45kv"
key_vault_uri = f"https://azureb45kv.vault.azure.net"
...
def get_certs(request: Request, region: str):
    acm_conn = boto3.client(
        'acm',
        region_name=region,
        aws_access_key_id=retrieved_secret1.value,
        aws_secret_access_key=retrieved_secret2.value
        )
